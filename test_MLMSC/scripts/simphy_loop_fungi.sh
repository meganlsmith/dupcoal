...
for lb in "${lb_values[@]}"; do
    ...
    for ld in "${ld_values[@]}"; do
        ...
        for c in "${c_values[@]}"; do
            ...
            output_dir="simphy_fungi_results/simphy_1_${lb}_${ld_name}_${c}"
            ...
            # Run SimPhy
            $SIMPHY_BIN -S "$sp_tree" -LB f:${lb_adj} -LD f:${ld_adj} -RL f:10000 -SP f:${sp_adj} -OD 1 -O "$output_dir" -SG f:${n_gen}
